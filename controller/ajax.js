let arrProizvodi, arrProizvod, arrFoot1, arrFoot2, arrFoot3, arrNav1, arrNav2, arrNav3;
...
async function getAll() {
    ...
    await getAllTestere();
    await getAllVideos();
    let sve = {arrProizvodi: arrProizvodi,
